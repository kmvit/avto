...
class Fine_category(models.Model):
    """
    Раздел нарушений
    """
...
class Fine(models.Model):
    ...
    Нарушения
    """
    category = models.ForeignKey(Fine_category, verbose_name='Раздел')
    title = models.CharField(max_length=1000, verbose_name='Название')
    offence = HTMLField(verbose_name='Нарушение')
...
class Rules_category(models.Model):
    """
    Раздел правил
    """
    title = models.CharField(max_length=1000, verbose_name='Название')
...
class Rule(models.Model):
    ...
    Правила
    """
    category = models.ForeignKey(Rules_category, verbose_name='Раздел')
    title = models.CharField(max_length=1000, verbose_name='Название')
...
class Road_category(models.Model):
    """
    Раздел дорожной разметки
    """
    title = models.CharField(max_length=1000, verbose_name='Название')
    class Meta:
...
class Road(models.Model):
    ...
    Дорожная разметка
    """
    category = models.ForeignKey(Road_category, verbose_name='Раздел')
    title = models.CharField(max_length=1000, verbose_name='Название')
    body = HTMLField(verbose_name='Содержание')
    class Meta:
...
class Roadsing_category(models.Model):
    """
    Раздел дорожных знаков
    """
    title = models.CharField(max_length=1000, verbose_name='Название')
    slug = models.SlugField(verbose_name='Адрес', default='sdf')
    img = models.ImageField(upload_to='roadsing', verbose_name='Изображение')
    class Meta:
        verbose_name = 'Раздел знака дорожного движения'
        verbose_name_plural = '       Разделы знаков дорожного движения'

    def __unicode__(self):
        return self.title

class Roadsing(models.Model):
    """
    Дорожные знаки
    """
    category = models.ForeignKey(Roadsing_category, verbose_name='Раздел')
    number = models.CharField(max_length=20, verbose_name='Номер')
    title = models.CharField(max_length=1000, verbose_name='Название')
    img = models.ImageField(upload_to='roadsing', verbose_name='Изображение')
    img2 = models.ImageField(upload_to='roadsing', blank=True, verbose_name='Изображение')
    img3 = models.ImageField(upload_to='roadsing', blank=True, verbose_name='Изображение')
    img4 = models.ImageField(upload_to='roadsing', blank=True, verbose_name='Изображение')
    img5 = models.ImageField(upload_to='roadsing', blank=True, verbose_name='Изображение')
    img6 = models.ImageField(upload_to='roadsing', blank=True, verbose_name='Изображение')
    body = HTMLField(verbose_name='Содержание')
    class Meta:
        verbose_name = 'Знак дорожного движения'
        verbose_name_plural = '        Знаки дорожного движения'
